...
<head>
    ...
    <title>Principal | E-Shopper</title>
...
<body>         
    ...
    <% 
        ...
        ArrayList<Produto> produtos = bll.buscarProdutos();
                            ...
                            <% }else{  %>    
                                <div class="form-inline" style="text-align:right ;">  
                                    ...
                                    <div class="form-group">
                                     ...
                                     <div class="form-group">
                                        <div class="shop-menu clearfix pull-right">
                                            <a href="ControleCompra?acao=buscarCompras"  id="SuaConta"  class="fa fa-home">Sua Conta</a>
                                        </div>
                                    </div>
                                    <div class="form-group">                                      
                                        <div class="shop-menu clearfix pull-right">                                          
    ...
    <div class="col-md-8 " style=" margin-left: 350px;" >    
        <div class="recommended_items"><!--recommended_items-->        
            <h2 class="title text-center">Produtos em alta</h2>            
                                                    ...
                                                    <div class="single-products">
                                                            <div class="productinfo text-center">
                                                                <img src="imagens/<%= p.getImagem()%>" width="200px" height="300px" alt="<%= p.getImagem()%>" />
                                                                    <h2><%=NumberFormat.getCurrencyInstance().format(p.getValorVenda())%></h2>
                                                                    <p><%= p.getNome() %></p>
                                     ...
                                     <div class="col-sm-4">
                                        <div class="product-image-wrapper">
                                            <div class="single-products">
                                                <div class="productinfo text-center">
                                                    <img src="imagens/<%= p.getImagem()%>" width="200px" height="300px" alt="<%= p.getImagem()%>" />
                                                    <h2>R$ <%=NumberFormat.getCurrencyInstance().format(p.getValorVenda())%></h2>
                                                    <p><%= p.getNome() %></p>
                                                    <a href="ControleCarrinho?acao=detalhesProduto&idProduto=<%=p.getIdProduto()%>"  class="btn btn-default add-to-cart " <i class="fa-shopping-bag"> Detalhes do Produto </a>
                                                </div>
                                            </div>
    ...
    <div class="features_items"><!--features_items-->
        ...
        <div class="col-sm-4">
            <div class="product-image-wrapper">
                <div class="single-products">
                    <div class="productinfo text-center">
                        <img   src="imagens/<%=produto.getImagem()%>" alt="<%=produto.getImagem()%>" width="200px" height="300px" />
                        <h2> <%=NumberFormat.getCurrencyInstance().format(produto.getValorVenda())%></h2>
                        ...
                        <a href="ControleCarrinho?acao=addProduto&idProduto=<%=produto.getIdProduto()%>" class="btn btn-default add-to-cart" id="<%=produto.getNome()%>" ><i class="fa fa-shopping-cart"></i>Adicionar ao Carrinho</a>
                    </div>
